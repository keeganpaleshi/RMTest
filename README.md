...
If `--config` is not supplied, `analyze.py` automatically looks for a `config.yaml` file in the same directory as the script. All configuration values should be defined in this file.
