...
def test_plot_spectrum_irregular_edges_residuals(tmp_path, monkeypatch):
    ...
    fit_vals = {"beta0": 0.0, "beta1": 0.0, "S_bkg": 40.0}
    plot_spectrum(
        energies,
        fit_vals=fit_vals,
        bin_edges=edges,
    ...
    bkg_shape = make_linear_bkg(edges[0], edges[-1])(centers, fit_vals["beta0"], fit_vals["beta1"])
    model_counts = fit_vals["S_bkg"] * bkg_shape * width
