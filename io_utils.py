    ...
    "properties": {
        ...
        "time_fit": {
            ...
            "properties": {
                ...
                "model": {
                    "type": "string",
                    "enum": ["single_exp", "bi_exp", "constant", "poisson_decays"],
                },
                "t0": {"type": "number"},
                ...
                "background_guess": {"type": "number"},
                "n0_guess_fraction": {"type": "number"},
                "fix_background_b_first_pass": {"type": "boolean"},
                "background_b_fixed_value": {"type": ["number", "null"]},
                "sig_n0_po214": {"type": "number"},
                "sig_n0_po218": {"type": "number"},
                "sig_n0_po210": {"type": "number"},
                "sig_N0_Po214": {"type": "number"},
                "sig_N0_Po218": {"type": "number"},
                "sig_N0_Po210": {"type": "number"},
                "bkg_po214": {
